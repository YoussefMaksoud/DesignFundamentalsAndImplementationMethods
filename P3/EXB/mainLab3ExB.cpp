...
void print(LookupTable<LT_key, LT_Datum>& lt);

template<class LT_key, class LT_Datum> 
void try_to_find(LookupTable<LT_key, LT_Datum>& lt, int key);

void test_Customer();

//Uncomment the following function calls when ready to test template class LookupTable<LT_key, LT_Datum>
void test_String();
void test_integer();
...
// Uncomment and modify the following funciton when ready to test LookupTable<LT_key, LT_Datum><int,Mystring>

void test_String()

  // creating lookuptable<LT_key, LT_Datum> for Mystring objects
  {
    cout<<"\nCreating and testing LookupTable<LT_key, LT_Datum> <int, Mystring> .....\n";
...
// Uncomment and modify the following funciton when ready to test LookupTable<LT_key, LT_Datum><int,int>
...
void test_integer()
  ...
  {
    cout<<"\nCreating and testing LookupTable<LT_key, LT_Datum> <int, int> .....\n";
